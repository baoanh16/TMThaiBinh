...
var currCulture;
var lang = {};
lang['en'] = { 'name': '', 'searchResultName': '', 'fax':'Fax','phoneMaintenance':'Maintenance','hotline':'Hotline','phone': 'Phone', 'address': 'Address', 'zoom': 'Zoom', 'direction': 'Direction', 'directionNotFound': 'Direction not found. Please try again', 'notFound': 'No results ', 'found': 'Found ', 'locations': ' ', 'matchYourSearch': ' match your search', 'nearYourLocation': ' near your location', 'from': 'From', 'to': 'To', 'back': 'Back' };
lang['vi'] = { 'name': '', 'searchResultName': '', 'fax':'Fax','phoneMaintenance':'Bảo trì sữa chữa','hotline':'Hotline', 'phone': 'Điện thoại', 'address': 'Địa chỉ', 'zoom': 'Phóng to', 'direction': 'Tìm đường đi', 'directionNotFound': 'Không tìm thấy đường đi. Vui lòng thử lại', 'notFound': 'Không tìm thấy địa điểm ', 'found': 'Có ', 'locations': ' ', 'matchYourSearch': ' phù hợp với tìm kiếm của bạn', 'nearYourLocation': ' gần với vị trí của bạn', 'from': 'Từ', 'to': 'Đến', 'back': 'Trở lại' };

$(document).ready(function() {
	//nếu không có quốc gia 
	setTimeout(function () { $("#ddlCountry").val("99f791e7-7343-42e8-8c19-3c41068b5f8d").trigger("change"); }, 1000);
...
function gmap_province_lookup(distance, region, userlat, userlng) {
 ...
 console.log(v);
                    ...
                    if (v.getAttribute("hotline") != "") {
                        phoneFax += "<div><span>" + lang[currCulture].hotline + ":</span> " + v.getAttribute("hotline") + "</div>";
                    }
